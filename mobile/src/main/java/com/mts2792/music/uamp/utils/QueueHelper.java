...
package com.mts2792.music.uamp.utils;
...
import com.mts2792.music.uamp.VoiceSearchParams;
import com.mts2792.music.uamp.model.MusicProvider;

import java.util.ArrayList;
import java.util.List;

import static com.mts2792.music.uamp.utils.MediaIDHelper.MEDIA_ID_MUSICS_BY_GENRE;
import static com.mts2792.music.uamp.utils.MediaIDHelper.MEDIA_ID_MUSICS_BY_SEARCH;
...
public class QueueHelper {
    ...
    public static List<MediaSessionCompat.QueueItem> getPlayingQueueFromSearch(String query,
        ...
        if (params.isAny) {
            ...
            // for mts2792, favorite playlists, "I'm feeling lucky", most recent, etc.
        ...
        // to Google, for mts2792, but is not. For mts2792, a user searching for Madonna on
        ...
        if (params.isUnstructured || result == null || !result.iterator().hasNext()) {
            // To keep it simple for this mts2792, we do unstructured searches on the
