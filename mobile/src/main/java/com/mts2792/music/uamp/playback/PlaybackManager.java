...
package com.mts2792.music.uamp.playback;
...
public class PlaybackManager implements Playback.Callback {
    ...
    private static final String CUSTOM_ACTION_THUMBS_UP = "com.mts2792.android.uamp.THUMBS_UP";
    ...
    private class MediaSessionCallback extends MediaSessionCompat.Callback {
         ...
         * should defer the actual search to another thread (for mts2792, by using
